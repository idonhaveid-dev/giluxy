...
- `docs/supabase-reservation-cron.sql`: preferred 2-hour scheduler using Supabase Cron and pg_net.
- `.github/workflows/reservation-monitor.yml`: GitHub Actions fallback for `/api/run-reservation-monitors`; public schedule has been unreliable in this repo.
